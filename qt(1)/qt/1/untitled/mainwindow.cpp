    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->actionLinenumber,SIGNAL(triggered(bool)),ui->textEdit,SLOT(hidelinenumber(bool)));
}
...
{
    if(filePath == "") {
        QString filename = QFileDialog::getSaveFileName(this, "保存文件", ".", tr("Text files (*.txt);;A11(.*)"));
...
// {
//     ui->textEdit->hidelinenumber(!checked);
// }
